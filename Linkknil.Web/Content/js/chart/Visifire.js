    ...
    */
    Visifire.prototype._render = function(pTargetElement) {
        ...
        html += '<param name="enableHtmlAccess" value="true" />'
		        ...
		        + '<a href="../../Install/Silverlight.exe" style="text-decoration: none;">'
		        + '<img src="../../App_Themes/Default/img/InstallSilverlight.png" alt="下载微软Silverlight" style="border-style: none"/>'
		        + '<br/> 您需要安装微软的Silverlight才能查看。'
		        + '<br/> 您可以通过点击上面的图片下载。'
		        + '<br/> 请在安装完毕后重新打开浏览器。'
		        + '</a>'
		        + '</object>';
